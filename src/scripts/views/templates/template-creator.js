...
const createRestaurantDetailTemplate = (restaurant) => `
  ...
  <img class="lazyload resto-item__thumbnail" data-src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL_M + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="this photo of ${restaurant.name} restaurant.">
...
<article tabindex="0" class="resto-item">
<p class="resto-item__city" aria-label="This cafe from City ${restaurant.city}, Indonesia.">City : ${restaurant.city}</p>
<img class="lazyload resto-item__thumbnail" data-src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL_S + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="this photo of ${restaurant.name} restaurant.">
<div class="resto-item__content">
    <p class="resto-item__rating" aria-label="This cafe rating is ${restaurant.rating}.">Rating  : ${restaurant.rating}</p>
